...
public class JobWorker {
    ...
    public JobWorker(JobQueueService queueService, StringRedisTemplate redisTemplate, AppConfig appConfig) {
    ...
    public void processStream() {
        ...
        try {
            List<MapRecord<String, Object, Object>> messages = redisTemplate.opsForStream().read(
                ...
                StreamOffset.create(JobQueueService.STREAM_NAME, ReadOffset.lastConsumed())
            );
            ...
            for (MapRecord<String, Object, Object> record : messages) {
                ...
                if (jobId == null) {
                    redisTemplate.opsForStream().acknowledge(JobQueueService.STREAM_NAME, JobQueueService.CONSUMER_GROUP, record.getId());
                    continue;
                }
